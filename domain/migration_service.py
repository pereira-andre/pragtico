            ...
            for port_call in port_calls:
                cur.execute(
                    ...
                    ON CONFLICT (id) DO UPDATE SET
                        ...
                        vessel_short_name = EXCLUDED.vessel_short_name,
                        vessel_imo = EXCLUDED.vessel_imo,
                        vessel_call_sign = EXCLUDED.vessel_call_sign,
                        vessel_flag = EXCLUDED.vessel_flag,
                        vessel_type = EXCLUDED.vessel_type,
                        vessel_loa_m = EXCLUDED.vessel_loa_m,
                        vessel_beam_m = EXCLUDED.vessel_beam_m,
                        vessel_gt_t = EXCLUDED.vessel_gt_t,
                        vessel_max_draft_m = EXCLUDED.vessel_max_draft_m,
                        vessel_dwt_t = EXCLUDED.vessel_dwt_t,
                        vessel_bow_thruster = EXCLUDED.vessel_bow_thruster,
                        vessel_stern_thruster = EXCLUDED.vessel_stern_thruster,
                        ...
                        planned_shift_at = EXCLUDED.planned_shift_at,
                        shift_plan_note = EXCLUDED.shift_plan_note,
                        shift_at = EXCLUDED.shift_at,
                        shift_origin_berth = EXCLUDED.shift_origin_berth,
                        shift_destination_berth = EXCLUDED.shift_destination_berth,
                        shift_approval_status = EXCLUDED.shift_approval_status,
                        shift_approval_note = EXCLUDED.shift_approval_note,
                        shift_aborted_reason = EXCLUDED.shift_aborted_reason,
                        shift_decided_by = EXCLUDED.shift_decided_by,
                        shift_decided_at = EXCLUDED.shift_decided_at,
                        maneuver_history = EXCLUDED.maneuver_history,
                    ...
                    (
                        ...
                        port_call.get("vessel_short_name", ""),
                        port_call.get("vessel_imo", ""),
                        port_call.get("vessel_call_sign", ""),
                        port_call.get("vessel_flag", ""),
                        port_call.get("vessel_type", ""),
                        port_call.get("vessel_loa_m", ""),
                        port_call.get("vessel_beam_m", ""),
                        port_call.get("vessel_gt_t", ""),
                        port_call.get("vessel_max_draft_m", ""),
                        port_call.get("vessel_dwt_t", ""),
                        port_call.get("vessel_bow_thruster", "unknown"),
                        port_call.get("vessel_stern_thruster", "unknown"),
                        port_call["status"],
                        ...
                        port_call.get("planned_shift_at"),
                        port_call.get("shift_plan_note", ""),
                        port_call.get("shift_at"),
                        port_call.get("shift_origin_berth", ""),
                        port_call.get("shift_destination_berth", ""),
                        port_call.get("shift_approval_status", "pending"),
                        port_call.get("shift_approval_note", ""),
                        port_call.get("shift_aborted_reason", ""),
                        port_call.get("shift_decided_by"),
                        port_call.get("shift_decided_at"),
                        json.dumps(port_call.get("maneuver_history", [])),
                        port_call.get("berth"),
