...
BEAUFORT_SCALE: tuple[BeaufortBand, ...] = (
    ...
    BeaufortBand(6, "22-27 kt", "39-49 km/h", "vento fresco", "Avaliar viabilidade, meios e margem; a faixa inclui o limite local de 25 kt."),
    BeaufortBand(7, "28-33 kt", "50-61 km/h", "vento forte", "Acima do limite praticavel local; suspender se vento/rajada for superior a 25 kt."),
    BeaufortBand(8, "34-40 kt", "62-74 km/h", "temporal", "Muito para la do limite local praticavel; manobras suspensas."),
