...
def build_slash_help(role: str) -> str:
    ...
    lines = [
        ...
        "/lua [hoje|amanhã|DD/MM/AAAA]",
        "  mostra a fase da lua",
        "/luz [hoje|amanhã|DD/MM/AAAA]",
        "  mostra nascer do sol, pôr do sol e período luminoso",
        "/colreg-lista",
        "  lista as regras RIEAM/COLREG por número e título",
        "/colreg 19",
        "  mostra uma regra RIEAM/COLREG específica; aliases: /rieam, /regra-colreg",
        "/regras",
