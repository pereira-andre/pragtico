...
BOT_CRITICAL_TEST_MATRIX: list[dict] = [
    ...
    },
    {
        ...
        "question": "A fonte de balizagem/luzes de Setubal esta indexavel no RAG?",
    ...
    },
    {
        ...
        "question": "O bot tem contexto historico/cultural de Setubal sem misturar com regras tecnicas?",
